...
\begin{frame}[fragile]
    ...
    \begin{itemize}
        ...
        \item Rootbeer war nicht thread-safe
              % shared-libraries in home + statische Variablen
  \end{itemize}
...
\end{lstlisting}
    \only<1>{\centerline{\includegraphics[width=1.2\linewidth]{../MontePi/profiling/2of4-APICalls.png}}}
    \only<2>{\centerline{\includegraphics[width=1.2\linewidth]{../MontePi/profiling/2of2-afterLoadDevicesPerformanceFix.png}}}
\end{frame}
...
\begin{frame}
    \frametitle{Weak-Scaling Benchmark Spark mit Rootbeer}
    % "warum haben sie die neue Version nicht gebenchmarkt?" -> wegen Rootbeerproblemen -> deshalb rootbeer folie vor dieser
    \only<1>{\centerline{\includegraphics[width=1.0\linewidth]{../MontePi/benchmark/weak-scaling-time-gpu.pdf}}}
    \only<2>{\centerline{\includegraphics[width=1.0\linewidth]{../MontePi/benchmark/weak-scaling-speedup-gpu.pdf}}}
    \only<3>{\centerline{\includegraphics[width=1.0\linewidth]{../MontePi/benchmark/weak-scaling-efficiency-gpu.pdf}}}
\end{frame}

\begin{frame}
    \frametitle{Strong-Scaling Benchmark Spark mit Rootbeer}
    % "warum haben sie die neue Version nicht gebenchmarkt?" -> wegen Rootbeerproblemen -> deshalb rootbeer folie vor dieser
    \only<1>{\centerline{\includegraphics[width=1.0\linewidth]{../MontePi/benchmark/strong-scaling-time-gpu.pdf}}}
    \only<2>{\centerline{\includegraphics[width=1.0\linewidth]{../MontePi/benchmark/strong-scaling-speedup-gpu.pdf}}}
    \only<3>{\centerline{\includegraphics[width=1.0\linewidth]{../MontePi/benchmark/strong-scaling-efficiency-gpu.pdf}}}
\end{frame}
